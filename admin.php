...
?>    
    ...
    <div class="my-auto upload-container">
        <form action="includes/gallery-helper.php" method="POST" enctype="multipart/form-data">
            ...
            <img src="images/cluster.png" onclick="triggered();" id="gallery-display">
            ...
            <div class="form-group">
                <button type="submit" name="gallery-submit" class="btn btn-outline-dark btn-sm btn-block">upload</button>
            </div>
        </form>
    </div>
</div>
