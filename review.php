        ...
        <div class="my-auto">
            <form id="review-form" action="includes/review-helper.php" method="post">
                ...
                <div class="form-group">
                    <button class="btn btn-outline-dark" id="review-submit" name="review-submit" type="submit" style="width: 100%;">Review</button>
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    function xhr_getter(prefix, element){
        ...
        xhttp.onreadystatechange = function(){
            if(this.readyState == 4 && this.status == 200){ //200 means all good
